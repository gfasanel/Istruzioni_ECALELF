...
#where=lsf
where=remoteGlidein
./scripts/prodNtuples.sh `parseDatasetFile.sh alcareco_datasets.dat | grep emanuele-ZElectron_Run2015D_v3` --skim ZSkim --type MINIAOD -t config/reRecoTags/74X_dataRun2_Prompt_v4.py --scheduler=${where} --createOnly
